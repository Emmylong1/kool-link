...
export const WHATSAPP_TEXT =
  "Hi Cool Flow! I want to order ice blocks. Name: ____ | Location: ____ | Ice Type: ____ | Quantity: ____";
export const WHATSAPP_LINK = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
  WHATSAPP_TEXT
)}`;
export const REQUEST_LINK = `Hello Cool Flow! I would like to request more information about your ice products and delivery services.
